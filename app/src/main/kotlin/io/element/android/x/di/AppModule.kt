...
import io.prism.android.appconfig.ApplicationConfig
import io.prism.android.features.enterprise.api.EnterpriseService
import io.prism.android.libraries.androidutils.system.getVersionCodeFromManifest
...
import io.prism.android.libraries.recentemojis.impl.DefaultEmojibaseProvider
...
object AppModule {
    ...
    fun providesAppCoroutineScope(): CoroutineScope {
        return MainScope() + CoroutineName("PRISM Scope")
    }
