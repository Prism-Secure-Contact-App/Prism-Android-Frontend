...
plugins {
    id("io.prism.android-compose-application")
...
android {
    ...
    signingConfigs {
        ...
        register("release") {
            keyAlias = System.getenv("PRISM_ANDROID_RELEASE_KEYID")
                ?: project.findProperty("signing.prism.release.keyId") as? String
            keyPassword = System.getenv("PRISM_ANDROID_RELEASE_KEYPASSWORD")
                ?: project.findProperty("signing.prism.release.keyPassword") as? String
            storeFile = file("./signature/release.keystore")
            storePassword = System.getenv("PRISM_ANDROID_RELEASE_STOREPASSWORD")
                ?: project.findProperty("signing.prism.release.storePassword") as? String
        }
        register("nightly") {
            keyAlias = System.getenv("PRISM_ANDROID_NIGHTLY_KEYID")
                ?: project.findProperty("signing.prism.nightly.keyId") as? String
            keyPassword = System.getenv("PRISM_ANDROID_NIGHTLY_KEYPASSWORD")
                ?: project.findProperty("signing.prism.nightly.keyPassword") as? String
            storeFile = file("./signature/nightly.keystore")
            storePassword = System.getenv("PRISM_ANDROID_NIGHTLY_STOREPASSWORD")
                ?: project.findProperty("signing.prism.nightly.storePassword") as? String
        }
    }
...
licensee {
    ...
    ignoreDependencies("com.github.prism-org", "prism-analytics-events")
    // Ignore dependency that are not third-party licenses to us.
    ignoreDependencies(groupId = "io.prism.android")
}
