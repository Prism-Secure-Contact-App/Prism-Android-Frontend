...
import io.prism.android.libraries.prism.test.A_REASON
...
import io.prism.android.libraries.prism.test.room.aRemoteLatestEvent
import io.prism.android.libraries.prism.test.timeline.aPollContent
import io.prism.android.libraries.prism.test.timeline.aProfileChangeMessageContent
import io.prism.android.libraries.prism.test.timeline.aProfileDetails
import io.prism.android.libraries.prism.test.timeline.aStickerContent
import io.prism.android.libraries.prism.test.timeline.item.event.aRoomMembershipContent
...
class DefaultRoomLatestEventFormatterTest {
    ...
    private lateinit var fakePRISMClient: FakePRISMClient
    private lateinit var formatter: DefaultRoomLatestEventFormatter

    @Before
    fun setup() {
        context = RuntimeEnvironment.getApplication() as Context
        fakePRISMClient = FakePRISMClient()
        ...
        formatter = DefaultRoomLatestEventFormatter(
            ...
            roomMembershipContentFormatter = RoomMembershipContentFormatter(fakePRISMClient, stringProvider),
