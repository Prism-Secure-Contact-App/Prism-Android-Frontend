...
@Composable
internal fun IconsCompoundPreviewLight() = PRISMTheme {
    IconsCompoundPreview()
}

@Preview(widthDp = 730, heightDp = 1920)
@Composable
internal fun IconsCompoundPreviewRtl() = PRISMTheme {
...
@Preview(widthDp = 730, heightDp = 1920)
@Composable
internal fun IconsCompoundPreviewDark() = PRISMTheme(darkTheme = true) {
    IconsCompoundPreview()
}
