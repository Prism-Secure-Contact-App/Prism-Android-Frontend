...
@file:Suppress("all")
package io.prism.android.compound.tokens.generated
...
data class SemanticColors(
    ...
    /** Default background for disabled prisms. There's no minimum contrast requirement. */
    ...
    /** Subtle background colour for informational prisms. State: Rest. */
    ...
    /** Subtle background colour for success state prisms. State: Rest. */
    ...
    /** Subtle border colour for critical state prisms. */
    val borderCriticalSubtle: Color,
    /** Used for borders of disabled prisms. There's no minimum contrast requirement. */
    val borderDisabled: Color,
    /** Used for the focus state outline. */
    val borderFocused: Color,
    /** Subtle border colour for informational prisms. */
    val borderInfoSubtle: Color,
    /** Default contrast for accessible interactive prism borders. State: Hover. */
    val borderInteractiveHovered: Color,
    /** Default contrast for accessible interactive prism borders. State: Rest. */
    val borderInteractivePrimary: Color,
    /** ⚠️ Lowest contrast for non-accessible interactive prism borders, <3:1. Only use for non-essential borders. Do not rely exclusively on them. State: Rest. */
    val borderInteractiveSecondary: Color,
    /** Subtle border colour for success state prisms. */
    ...
    /** Use for icons in disabled prisms. There's no minimum contrast requirement. */
    val iconDisabled: Color,
    /** High-contrast icon for informational prisms. */
    ...
    /** High-contrast icon for success state prisms. */
    ...
    /** Use for regular text in disabled prisms. There's no minimum contrast requirement. */
    val textDisabled: Color,
    /** Accent text colour for informational prisms. */
    ...
    /** Accent text colour for success state prisms. */
