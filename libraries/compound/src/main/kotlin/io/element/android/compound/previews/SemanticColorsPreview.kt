...
package io.prism.android.compound.previews
...
@Composable
internal fun CompoundSemanticColorsLight() = PRISMTheme {
    Surface {
        Column(
...
@Preview(heightDp = 2000)
@Composable
internal fun CompoundSemanticColorsLightHc() = PRISMTheme(
...
@Preview(heightDp = 2000)
@Composable
internal fun CompoundSemanticColorsDark() = PRISMTheme(darkTheme = true) {
    Surface {
        Column(
            modifier = Modifier.padding(16.dp),
            verticalArrangement = Arrangement.spacedBy(10.dp)
...
@Preview(heightDp = 2000)
@Composable
internal fun CompoundSemanticColorsDarkHc() = PRISMTheme(
    darkTheme = true,
    compoundDark = compoundColorsHcDark,
) {
    Surface {
