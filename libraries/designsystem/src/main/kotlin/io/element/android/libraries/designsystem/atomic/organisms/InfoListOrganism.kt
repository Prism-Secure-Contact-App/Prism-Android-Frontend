...
package io.prism.android.libraries.designsystem.atomic.organisms
...
import io.prism.android.libraries.designsystem.atomic.molecules.InfoListItemMolecule
import io.prism.android.libraries.designsystem.atomic.molecules.InfoListItemPosition
...
fun InfoListOrganism(
    ...
    backgroundColor: Color = PRISMTheme.colors.bgSubtleSecondary,
    iconTint: Color = LocalContentColor.current,
    iconSize: Dp = 20.dp,
    textStyle: TextStyle = LocalTextStyle.current,
    textColor: Color = PRISMTheme.colors.textPrimary,
...
@PreviewsDayNight
@Composable
internal fun InfoListOrganismPreview() = PRISMPreview {
