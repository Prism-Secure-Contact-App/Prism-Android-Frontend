...
fun SearchField(
    ...
    BasicTextField(
        ...
        cursorBrush = SolidColor(PRISMTheme.colors.textActionAccent),
    ...
    SearchFieldContainer(
        ...
        Row(modifier = Modifier.padding(start = 16.dp), verticalAlignment = Alignment.CenterVertically) {
            ...
            IconButton(onClick = onClear, enabled = showClearIcon) {
                if (showClearIcon) {
                    Icon(
                        modifier = Modifier.background(PRISMTheme.colors.iconSecondary, CircleShape),
...
private fun SearchFieldContainer(
    ...
    Surface(
        ...
        border = BorderStroke(
            width = 1.dp,
            color = if (isFocused) {
                PRISMTheme.colors.borderInteractiveHovered
            } else {
...
@Composable
internal fun SearchFieldsLightPreview() = PRISMPreviewLight { ContentToPreview() }

@Preview(group = PreviewGroup.Search, heightDp = 1000)
@Composable
internal fun SearchFieldsDarkPreview() = PRISMPreviewDark { ContentToPreview() }
