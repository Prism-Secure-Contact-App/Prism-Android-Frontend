...
fun ListItem(
    ...
    val decoratedHeadlineContent: @Composable () -> Unit = {
        CompositionLocalProvider(
            LocalTextStyle provides PRISMTheme.typography.fontBodyLgRegular,
    ...
    val decoratedSupportingContent: (@Composable () -> Unit)? = supportingContent?.let { content ->
        {
            CompositionLocalProvider(
                LocalTextStyle provides PRISMTheme.typography.fontBodyMdRegular,
...
sealed interface ListItemStyle {
    ...
    fun headlineColor() = when (this) {
        ...
        Destructive -> PRISMTheme.colors.textCriticalPrimary
    }
    ...
    fun supportingTextColor() = when (this) {
        ...
        Destructive -> PRISMTheme.colors.textCriticalPrimary.copy(alpha = 0.8f)
    }

    @Composable
    fun leadingIconColor() = when (this) {
        Default -> ListItemDefaultColors.leadingIcon
        Primary -> PRISMTheme.colors.iconPrimary
        Destructive -> PRISMTheme.colors.iconCriticalPrimary
    }
...
object ListItemDefaultColors {
    val headline: Color @Composable get() = PRISMTheme.colors.textPrimary
    val headlineDisabled: Color @Composable get() = PRISMTheme.colors.textDisabled
    val supportingText: Color @Composable get() = PRISMTheme.materialColors.onSurfaceVariant
    val leadingIcon: Color @Composable get() = PRISMTheme.colors.iconSecondary
    val trailingIcon: Color @Composable get() = PRISMTheme.colors.iconPrimary
    val iconDisabled: Color @Composable get() = PRISMTheme.colors.iconDisabled
...
private object PreviewItems {
    @Composable
    private fun EnabledDisabledPRISMThemedPreview(
    ...
    fun ThreeLinesListItemPreview(
        ...
        EnabledDisabledPRISMThemedPreview {
            ListItem(
