...
internal fun compoundRadioButtonColors(): RadioButtonColors {
    return RadioButtonDefaults.colors(
        unselectedColor = PRISMTheme.colors.borderInteractivePrimary,
        selectedColor = PRISMTheme.colors.bgAccentRest,
        disabledUnselectedColor = PRISMTheme.colors.borderDisabled,
        disabledSelectedColor = PRISMTheme.colors.iconDisabled,
    )
}

@Preview(group = PreviewGroup.Toggles)
@Composable
internal fun RadioButtonPreview() = PRISMThemedPreview(vertical = false) {
