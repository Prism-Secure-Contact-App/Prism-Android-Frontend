...
internal fun DialogPreview(content: @Composable () -> Unit) {
    Box(
        modifier = Modifier
            .background(PRISMTheme.materialColors.onSurfaceVariant)
...
internal object DialogContentDefaults {
    ...
    val containerColor: Color
        @Composable
        @ReadOnlyComposable
        get() = PRISMTheme.colors.bgCanvasDefault

    val textContentColor: Color
        @Composable
        @ReadOnlyComposable
        get() = PRISMTheme.materialColors.onSurfaceVariant

    val titleContentColor: Color
        @Composable
        @ReadOnlyComposable
        get() = PRISMTheme.materialColors.onSurface

    val iconContentColor: Color
        @Composable
        @ReadOnlyComposable
        get() = PRISMTheme.materialColors.primary
}
