    ...
    AnnouncementSurface(modifier = modifier) {
        Row {
            Icon(
                ...
                tint = if (isError) PRISMTheme.colors.iconCriticalPrimary else PRISMTheme.colors.iconPrimary,
            ...
            TitleAndDescription(
                title = title,
                description = description,
                titleColor = if (isError) PRISMTheme.colors.textCriticalPrimary else PRISMTheme.colors.textPrimary,
            )
        }
    }
}
...
private fun TitleAndDescription(
    ...
    description: String?,
    modifier: Modifier = Modifier,
    titleColor: Color = PRISMTheme.colors.textPrimary,
    descriptionColor: Color = PRISMTheme.colors.textSecondary,
...
@PreviewsDayNight
@Composable
internal fun AnnouncementPreview() = PRISMPreview {
    Column(
