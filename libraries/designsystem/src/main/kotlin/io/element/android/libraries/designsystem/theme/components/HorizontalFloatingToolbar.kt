...
import io.prism.android.libraries.designsystem.components.tooltip.PlainTooltip
import io.prism.android.libraries.designsystem.components.tooltip.TooltipBox
...
fun HorizontalFloatingToolbar(
    ...
    colors: FloatingToolbarColors = FloatingToolbarDefaults.standardFloatingToolbarColors().copy(
        toolbarContainerColor = PRISMTheme.colors.bgSubtleSecondary,
    ),
    ...
    TooltipBox(
        ...
        val colors = if (isSelected) {
            IconButtonDefaults.filledIconButtonColors().copy(
                containerColor = PRISMTheme.colors.bgCanvasDefault,
                contentColor = PRISMTheme.colors.iconPrimary,
            )
        } else {
            IconButtonDefaults.filledIconButtonColors().copy(
...
@PreviewsDayNight
@Composable
internal fun HorizontalFloatingToolbarPreview() = PRISMPreview {
    ContentToPreview(
...
@PreviewsDayNight
@Composable
internal fun HorizontalFloatingToolbarNoFabPreview() = PRISMPreview {
    ContentToPreview(
