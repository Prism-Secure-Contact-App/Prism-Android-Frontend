...
fun HeaderFooterPage(
    ...
    containerColor: Color = PRISMTheme.colors.bgCanvasDefault,
...
@PreviewsDayNight
@Composable
internal fun HeaderFooterPagePreview() = PRISMPreview {
    HeaderFooterPage(
        content = {
            Box(
...
@PreviewsDayNight
@Composable
internal fun HeaderFooterPageScrollablePreview() = PRISMPreview {
    HeaderFooterPage(
        content = {
            Box(
                modifier = Modifier.fillMaxWidth(),
