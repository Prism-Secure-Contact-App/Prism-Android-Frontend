...
import io.prism.android.libraries.designsystem.theme.temporaryColorBgSpecial
...
fun RoundedIconAtom(
    ...
    tint: Color = PRISMTheme.colors.iconSecondary,
    backgroundTint: Color = PRISMTheme.colors.temporaryColorBgSpecial,
) {
    Box(
        modifier = modifier
...
@PreviewsDayNight
@Composable
internal fun RoundedIconAtomPreview() = PRISMPreview {
