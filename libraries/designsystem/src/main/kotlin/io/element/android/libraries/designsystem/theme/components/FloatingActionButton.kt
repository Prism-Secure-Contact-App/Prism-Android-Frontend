...
fun FloatingActionButton(
    ...
    containerColor: Color = PRISMTheme.colors.bgAccentRest,
    contentColor: Color = PRISMTheme.colors.iconOnSolidPrimary,
...
@Composable
internal fun FloatingActionButtonPreview() = PRISMThemedPreview {
