...
fun <T> SearchBar(
    ...
    inactiveBarColors: SearchBarColors = PRISMSearchBarDefaults.inactiveColors(),
    activeBarColors: SearchBarColors = PRISMSearchBarDefaults.activeColors(),
...
object PRISMSearchBarDefaults {
    @OptIn(ExperimentalMaterial3Api::class)
    @Composable
    fun inactiveColors() = SearchBarDefaults.colors(
        containerColor = Color.Transparent,
        dividerColor = PRISMTheme.colors.borderInteractivePrimary,
        inputFieldColors = inactiveInputFieldColors(),
    )

    @Composable
    fun inactiveInputFieldColors() = TextFieldDefaults.colors(
        unfocusedPlaceholderColor = PRISMTheme.colors.textDisabled,
        focusedPlaceholderColor = PRISMTheme.colors.textDisabled,
        unfocusedTrailingIconColor = PRISMTheme.colors.iconDisabled,
        focusedTrailingIconColor = PRISMTheme.colors.iconDisabled,
        focusedContainerColor = PRISMTheme.colors.bgSubtleSecondary,
        unfocusedContainerColor = PRISMTheme.colors.bgSubtleSecondary,
        disabledContainerColor = PRISMTheme.colors.bgSubtleSecondary,
        errorContainerColor = PRISMTheme.colors.bgSubtleSecondary,
    )
    ...
    fun activeInputFieldColors() = TextFieldDefaults.colors(
        ...
        unfocusedLeadingIconColor = PRISMTheme.colors.iconPrimary,
        focusedLeadingIconColor = PRISMTheme.colors.iconPrimary,
        unfocusedTrailingIconColor = PRISMTheme.colors.iconTertiary,
        focusedTrailingIconColor = PRISMTheme.colors.iconTertiary,
...
@Composable
internal fun SearchBarInactivePreview() = PRISMThemedPreview { ContentToPreview() }

@Preview(group = PreviewGroup.Search)
@Composable
internal fun SearchBarActiveNoneQueryPreview() = PRISMThemedPreview {
    ContentToPreview(
        initialQuery = "",
        active = true,
    )
...
@Preview(group = PreviewGroup.Search)
@Composable
internal fun SearchBarActiveWithQueryPreview() = PRISMThemedPreview {
    ContentToPreview(
...
@Preview(group = PreviewGroup.Search)
@Composable
internal fun SearchBarActiveWithQueryNoBackButtonPreview() = PRISMThemedPreview {
    ContentToPreview(
        initialQuery = "search term",
        active = true,
...
@Preview(group = PreviewGroup.Search)
@Composable
internal fun SearchBarActiveWithNoResultsPreview() = PRISMThemedPreview {
    ContentToPreview(
        initialQuery = "search term",
        active = true,
...
@Preview(group = PreviewGroup.Search)
@Composable
internal fun SearchBarActiveWithContentPreview() = PRISMThemedPreview {
    ContentToPreview(
        initialQuery = "search term",
        active = true,
