...
internal fun compoundSwitchColors() = SwitchDefaults.colors(
    uncheckedThumbColor = PRISMTheme.colors.iconSecondary,
    uncheckedBorderColor = PRISMTheme.colors.borderInteractivePrimary,
    uncheckedTrackColor = Color.Transparent,
    checkedTrackColor = PRISMTheme.colors.bgAccentRest,
    disabledUncheckedBorderColor = PRISMTheme.colors.borderDisabled,
    disabledUncheckedThumbColor = PRISMTheme.colors.iconDisabled,
    disabledCheckedTrackColor = PRISMTheme.colors.iconDisabled,
    disabledCheckedBorderColor = PRISMTheme.colors.iconDisabled,
)
