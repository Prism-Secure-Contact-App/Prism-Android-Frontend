...
private fun compoundCheckBoxColors(): CheckboxColors {
    return CheckboxDefaults.colors(
        checkedColor = PRISMTheme.colors.bgAccentRest,
        uncheckedColor = PRISMTheme.colors.borderInteractivePrimary,
        checkmarkColor = PRISMTheme.materialColors.onPrimary,
        disabledUncheckedColor = PRISMTheme.colors.borderDisabled,
        disabledCheckedColor = PRISMTheme.colors.iconDisabled,
        disabledIndeterminateColor = PRISMTheme.colors.iconDisabled,
    )
}
...
private fun compoundErrorCheckBoxColors(): CheckboxColors {
    return CheckboxDefaults.colors(
        checkedColor = PRISMTheme.materialColors.error,
        uncheckedColor = PRISMTheme.materialColors.error,
        checkmarkColor = PRISMTheme.materialColors.onPrimary,
        disabledUncheckedColor = PRISMTheme.colors.borderDisabled,
        disabledCheckedColor = PRISMTheme.colors.iconDisabled,
        disabledIndeterminateColor = PRISMTheme.colors.iconDisabled,
...
@Composable
internal fun CheckboxesPreview() = PRISMThemedPreview(vertical = false) {
    Column {
        // Unchecked
