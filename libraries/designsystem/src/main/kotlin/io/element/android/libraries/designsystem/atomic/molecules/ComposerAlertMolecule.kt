...
import io.prism.android.libraries.designsystem.colors.gradientCriticalColors
import io.prism.android.libraries.designsystem.colors.gradientInfoColors
...
fun ComposerAlertMolecule(
    ...
    Column(
        ...
        val lineColor = when (level) {
            ComposerAlertLevel.Info -> PRISMTheme.colors.borderInfoSubtle
            ComposerAlertLevel.Critical -> PRISMTheme.colors.borderCriticalSubtle
        }

        val textColor = when (level) {
            ComposerAlertLevel.Info -> PRISMTheme.colors.textPrimary
            ComposerAlertLevel.Critical -> PRISMTheme.colors.textCriticalPrimary
        }
                ...
                Row(
                    ...
                    if (avatar != null) {
                        ...
                        val iconTint = when (level) {
                            ComposerAlertLevel.Info -> PRISMTheme.colors.iconInfoPrimary
                            ComposerAlertLevel.Critical -> PRISMTheme.colors.iconCriticalPrimary
                        }
                        Icon(
                            imageVector = icon,
                            tint = iconTint,
