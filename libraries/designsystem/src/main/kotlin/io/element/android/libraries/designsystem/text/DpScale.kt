...
package io.prism.android.libraries.designsystem.text
...
import io.prism.android.libraries.designsystem.preview.WithFontScale
    ...
    PRISMPreviewLight {
        ...
        Column(
            ...
            Text(
                ...
                style = PRISMTheme.typography.fontBodyLgRegular.copy(fontSize = fontSizeInDp.toSp())
            )
            Text(
                text = "Text with the same size (applyScaleUp)",
                style = PRISMTheme.typography.fontBodyLgRegular.copy(fontSize = fontSizeInDp.applyScaleUp().toSp())
            )
            Text(
                text = "Text with a smaller size (applyScaleDown)",
                style = PRISMTheme.typography.fontBodyLgRegular.copy(fontSize = fontSizeInDp.applyScaleDown().toSp())
            )
        }
    }
}
