...
fun TopAppBar(
    ...
    androidx.compose.material3.TopAppBar(
        ...
        navigationIcon = navigationIcon,
        actions = {
            CompositionLocalProvider(LocalContentColor provides PRISMTheme.colors.textActionPrimary) {
                actions()
            }
        },
        windowInsets = windowInsets,
...
@Composable
internal fun TopAppBarPreview() = PRISMThemedPreview {
    TopAppBar(
...
@Preview(group = PreviewGroup.AppBars)
@Composable
internal fun TopAppBarStrPreview() = PRISMThemedPreview {
    TopAppBar(
