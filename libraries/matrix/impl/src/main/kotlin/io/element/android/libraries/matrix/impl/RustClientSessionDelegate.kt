...
class RustClientSessionDelegate(
    ...
    private var client: WeakReference<RustPRISMClient> = WeakReference(null)

    /**
     * Sets the [ClientDelegate] for the [RustPRISMClient], and keeps a reference to the client so it can be used later.
     */
    fun bindClient(client: RustPRISMClient) {
