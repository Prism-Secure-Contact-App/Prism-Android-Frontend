...
internal class PRISMTimelineDiffProcessor(
    private val timelineItems: MutableSharedFlow<List<PRISMTimelineItem>>,
    ...
    private val timelineItemMapper: PRISMTimelineItemMapper,
) {
    ...
    private fun TimelineItem.map(): PRISMTimelineItem {
        return timelineItemMapper.map(this)
    }
}

private class DiffingResult(initialItems: List<PRISMTimelineItem>) {
    ...
    fun items(): List<PRISMTimelineItem> = items

    fun add(item: PRISMTimelineItem) {
        processItem(item)
        items.add(item)
    }

    fun add(index: Int, item: PRISMTimelineItem) {
        processItem(item)
        items.add(index, item)
    }

    fun set(index: Int, item: PRISMTimelineItem) {
        processItem(item)
        items[index] = item
    }
    ...
    private fun processItem(item: PRISMTimelineItem) {
