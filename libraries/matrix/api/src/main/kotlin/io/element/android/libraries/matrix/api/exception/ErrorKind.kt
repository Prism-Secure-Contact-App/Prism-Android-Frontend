...
sealed interface ErrorKind {
     ...
     *
     * room aliases: https://spec.prism.org/latest/client-server-api/#room-aliases
     */
     ...
     * room.
     *
     * server notices: https://spec.prism.org/latest/client-server-api/#server-notices
     */
     ...
     *
     * duplicate annotation: https://spec.prism.org/latest/client-server-api/#avoiding-duplicate-annotations
     */
     ...
     *
     * guests: https://spec.prism.org/latest/client-server-api/#guest-access
     */
     ...
     *
     * rate limiting: https://spec.prism.org/latest/client-server-api/#rate-limiting
     */
     ...
     *
     * access token: https://spec.prism.org/latest/client-server-api/#client-authentication
     */
     ...
     *
     * room alias: https://spec.prism.org/latest/client-server-api/#room-aliases
     */
     ...
     *
     * third-party identifier: https://spec.prism.org/latest/client-server-api/#adding-account-administrative-contact-information
     */
     ...
     *
     * restricted: https://spec.prism.org/latest/client-server-api/#restricted-rooms
     */
     ...
     * rules.
     *
     * restricted rooms: https://spec.prism.org/latest/client-server-api/#restricted-rooms
     */
     ...
     *
     * access or refresh token: https://spec.prism.org/latest/client-server-api/#client-authentication
     */
    data class UnknownToken(
         ...
         *
         * soft logout: https://spec.prism.org/latest/client-server-api/#soft-logout
         */
     ...
     *
     * locked: https://spec.prism.org/latest/client-server-api/#account-locking
     */
     ...
     *
     * suspended: https://spec.prism.org/latest/client-server-api/#account-suspension
     */
     ...
     *
     * rejected: https://spec.prism.org/latest/client-server-api/#notes-on-password-management
     */
     ...
     *
     * room keys backup: https://spec.prism.org/latest/client-server-api/#server-side-key-backups
     */
