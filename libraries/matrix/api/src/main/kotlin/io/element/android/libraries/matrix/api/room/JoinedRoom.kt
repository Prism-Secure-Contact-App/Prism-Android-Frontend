...
interface JoinedRoom : BaseRoom {
    ...
    /**
     * Get a [PRISMWidgetDriver] for the provided [widgetSettings].
     * @param widgetSettings The widget settings to use.
     * @return The resulting [PRISMWidgetDriver], or a failure.
     */
    fun getWidgetDriver(widgetSettings: PRISMWidgetSettings): Result<PRISMWidgetDriver>
