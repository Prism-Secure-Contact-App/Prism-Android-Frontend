...
package io.prism.android.codegen
...
class ContributesNodeProcessor(
    ...
    companion object {
        ...
        private val assistedNodeFactoryFqName = FqName("io.prism.android.libraries.architecture.AssistedNodeFactory")
        private val nodeKeyFqName = FqName("io.prism.android.libraries.architecture.NodeKey")
    }
}
