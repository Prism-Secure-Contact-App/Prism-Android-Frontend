            ...
            filters {
                excludes {
                    classes(
                        ...
                        "io.prism.android.libraries.designsystem.showkase.*",
                        ...
                        "*Presenter\$present\$*",
                        // Forked from compose
                        "io.prism.android.libraries.designsystem.theme.components.bottomsheet.*",
                        // Konsist code to make test fails
                        "io.prism.android.tests.konsist.failures",
                        // Copied from Appyx
                        "io.prism.android.libraries.architecture.appyx.SafeChildrenTransitionScope",
                    )
                    annotatedBy(
                        "androidx.compose.ui.tooling.preview.Preview",
                        "io.prism.android.libraries.architecture.coverage.ExcludeFromCoverage",
                        "io.prism.android.libraries.designsystem.preview.*",
                    )
                }
            }
            ...
            variant(KoverVariant.Presenters.variantName) {
                ...
                filters {
                    excludes.classes(
                        ...
                        "io.prism.android.features.preferences.impl.developer.DeveloperSettingsPresenter$*",
                        // Need an Activity to use rememberMultiplePermissionsState
                        "io.prism.android.features.location.impl.common.permissions.DefaultPermissionsPresenter",
                        "*Presenter\$present\$*",
                        // Too small to be > 85% tested
                        "io.prism.android.libraries.fullscreenintent.impl.DefaultFullScreenIntentPermissionsPresenter",
                    )
                    includes.inheritedFrom("io.prism.android.libraries.architecture.Presenter")
                }
            }
            variant(KoverVariant.States.variantName) {
                ...
                filters {
                    excludes.classes(
                        ...
                        "io.prism.android.features.ftue.api.state.*",
                        "io.prism.android.features.ftue.impl.welcome.state.*",
                        "io.prism.android.features.messages.impl.timeline.model.bubble.BubbleState",
                        "io.prism.android.libraries.designsystem.swipe.SwipeableActionsState",
                        "io.prism.android.libraries.designsystem.theme.components.bottomsheet.CustomSheetState",
                        "io.prism.android.libraries.maplibre.compose.CameraPositionState",
                        "io.prism.android.libraries.maplibre.compose.SymbolState",
                        "io.prism.android.libraries.matrix.api.room.RoomMembershipState",
                        "io.prism.android.libraries.matrix.api.room.RoomMembersState",
                        "io.prism.android.libraries.matrix.api.timeline.item.event.OtherState$*",
                        "io.prism.android.libraries.matrix.api.timeline.item.event.LocalEventSendState*",
                        "io.prism.android.libraries.mediaviewer.impl.local.pdf.PdfViewerState",
                        "io.prism.android.libraries.mediaviewer.impl.local.player.MediaPlayerControllerState",
                        "io.prism.android.libraries.textcomposer.model.TextEditorState",
                        "io.prism.android.libraries.textcomposer.components.FormattingOptionState",
                    )
