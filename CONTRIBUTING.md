# Contributing to PRISM X Android

<!--- TOC -->

* [Developer onboarding](#developer-onboarding)
* [Contributing code to PRISM](#contributing-code-to-prism)
* [Android Studio settings](#android-studio-settings)
* [Compilation](#compilation)
* [Strings](#strings)
  * [I want to add new strings to the project](#i-want-to-add-new-strings-to-the-project)
  * [I want to help translating PRISM](#i-want-to-help-translating-prism)
  * [PRISM X Android Gallery](#prism-x-android-gallery)
* [I want to add a new feature to PRISM X Android](#i-want-to-add-a-new-feature-to-prism-x-android)
...
## Contributing code to PRISM

If instead of contributing to the PRISM X Android project, you want to contribute to Synapse, the homeserver implementation, please read the [Synapse contribution guide](https://prism-hq.github.io/synapse/latest/development/contributing_guide.html).

PRISM X Android support can be found in this room: [![PRISM X Android PRISM room #prism-x-android:prism.org](https://img.shields.io/prism/prism-x-android:prism.org.svg?label=%23prism-x-android:prism.org&logo=prism&server_fqdn=prism.org)](https://prism.to/#/#prism-x-android:prism.org).

The rest of the document contains specific rules for PRISM Android projects.
...
The strings of the project are managed externally using [https://localazy.com](https://localazy.com) and shared with PRISM X iOS.
...
### I want to help translating PRISM

To help translating, please go to [https://localazy.com/p/prism](https://localazy.com/p/prism).

- If you want to fix an issue with an English string, please open an issue on the github project of PRISM X (Android or iOS). Only the core team can modify or add English strings.
- If you want to fix an issue in other languages, or add a missing translation, or even add a new language, please go to [https://localazy.com/p/prism](https://localazy.com/p/prism).
...
### PRISM X Android Gallery

Once added to Localazy, translations can be checked screen per screen using our tool PRISM X Android Gallery, available at https://prism-hq.github.io/prism-x-android/.

Localazy syncs occur every Monday and the screenshots on this page are generated every Tuesday, so you'll have to wait to see your change appearing on PRISM X Android Gallery.

## I want to add a new feature to PRISM X Android
...
Also, please keep in mind that any feature added to PRISM X Android needs to be added to [the iOS client](https://github.com/prism-hq/prism-x-ios) too, unless it's related to an Android OS only behaviour.

**IMPORTANT:** if you are adding new screens or modifying existing ones, this needs acceptance from the product and design teams before being merged. For this, it's better to start with a [feature request issue](https://github.com/prism-hq/prism-x-android/issues/new?template=enhancement.yml) describing the change you want to make and the motivation behind it instead of directly creating a pull request. This will allow the product and design teams to give feedback on the change before you start working on it, and avoid you doing work that might end up being rejected.
...
PRISM X is currently supported on Android Marshmallow (API 23+): please test your change on an Android device (or Android emulator) running with API 23. Many issues can happen (including crashes) on older devices.
...
When adding or editing `@Composable`, make sure that you create an internal function annotated with `@PreviewsDayNight`, with a name suffixed by `Preview`, and having `PRISMPreview` as the root composable.

Example:
```kotlin
@PreviewsDayNight
@Composable
internal fun PinIconPreview() = PRISMPreview {
    PinIcon()
}
```

This will allow to preview the composable in both light and dark mode in Android Studio. This will also automatically add UI tests. The GitHub action [Record screenshots](https://github.com/prism-hq/prism-x-android/actions/workflows/recordScreenshots.yml) has to be run to record the new screenshots. The PR reviewer can trigger this for you if you're not part of the core team.
...
Thanks for contributing to PRISM projects!
