...
allprojects {
    ...
    tasks.withType<io.gitlab.arturbosch.detekt.Detekt>().configureEach {
        exclude("io/prism/android/tests/konsist/failures/**")
    }
    ...
    configure<org.jlleitschuh.gradle.ktlint.KtlintExtension> {
        ...
        filter {
            exclude { prism -> prism.file.path.contains(generatedPath) }
            exclude("io/prism/android/tests/konsist/failures/**")
...
// Sonar result can be found here: https://sonarcloud.io/project/overview?id=prism-x-android
sonar {
    properties {
        property("sonar.projectName", "prism-x-android")
        property("sonar.projectKey", "prism-x-android")
        property("sonar.host.url", "https://sonarcloud.io")
        property("sonar.projectVersion", "1.0") // TODO project(":app").android.defaultConfig.versionName)
        property("sonar.sourceEncoding", "UTF-8")
        property("sonar.links.homepage", "https://github.com/prism-hq/prism-x-android/")
        property("sonar.links.ci", "https://github.com/prism-hq/prism-x-android/actions")
        property("sonar.links.scm", "https://github.com/prism-hq/prism-x-android/")
        property("sonar.links.issue", "https://github.com/prism-hq/prism-x-android/issues")
        property("sonar.organization", "prism-hq")
