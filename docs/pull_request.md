...
- The PR creator selects the [prism-x-android-reviewers](https://github.com/orgs/prism-hq/teams/prism-x-android-reviewers) team as a reviewer.
...
For PRs coming from the community, the issue wrangler can assign either the team [prism-x-android-reviewers](https://github.com/orgs/prism-hq/teams/prism-x-android-reviewers) or any member directly.
...
To review such PR, you have to
 ...
 - Check the release note. Some existing bugs in PRISM project may be fixed by the upgrade
...
7. All commit authors must have signed the CLA. Please open https://cla-assistant.io/prism-hq/prism-x-android to agree to the CLA.
...
> Closed in PRISM Android v1.x.y
