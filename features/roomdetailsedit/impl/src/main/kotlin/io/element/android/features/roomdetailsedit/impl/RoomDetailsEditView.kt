...
import io.prism.android.libraries.designsystem.modifiers.clearFocusOnTap
...
@PreviewsDayNight
@Composable
internal fun RoomDetailsEditViewPreview(@PreviewParameter(RoomDetailsEditStateProvider::class) state: RoomDetailsEditState) = PRISMPreview {
    RoomDetailsEditView(
        state = state,
        onDone = {},
    )
