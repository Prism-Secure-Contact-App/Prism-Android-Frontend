...
class ChangeRolesViewTest {
    ...
    fun `testing adding user to the selected list emits the expected event`() {
        ...
        val userToSelect = (state.searchResults as SearchBarResultState.Results).results.members.first().toPRISMUser()
    ...
    fun `testing removing user to the selected list emits the expected event`() {
        ...
        val userToSelect = (state.searchResults as SearchBarResultState.Results).results.moderators.first().toPRISMUser()
