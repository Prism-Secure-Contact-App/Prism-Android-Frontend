...
package io.prism.android.features.rolesandpermissions.impl.permissions
...
import io.prism.android.libraries.prism.api.room.RoomMember.Role.Admin
import io.prism.android.libraries.prism.api.room.RoomMember.Role.Moderator
...
class ChangeRoomPermissionsPresenterTest {
    ...
    fun `present - Save updates the current permissions and resets hasChanges`() = runTest {
        ...
        moleculeFlow(RecompositionMode.Immediate) {
            ...
            assertThat(analyticsService.capturedEvents).containsExactlyPRISMsIn(
                listOf(
