...
import io.prism.android.libraries.designsystem.components.dialogs.SaveChangesDialog
            ...
            Column(
                ...
                SearchBar(
                    ...
                    SearchResultsList(
                        ...
                        onToggleSelection = { state.eventSink(ChangeRolesEvent.UserSelectionToggled(it.toPRISMUser())) },
                        selectedUsersList = {},
                    )
                }
                AnimatedVisibility(
...
private fun SearchResultsList(
    ...
    lazyListState: LazyListState,
    selectedUsersList: @Composable (ImmutableList<PRISMUser>) -> Unit,
) {
    LazyColumn(
        state = lazyListState,
    ) {
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                if (isPending) {
                    Text(
                        ...
                        style = PRISMTheme.typography.fontBodySmRegular.copy(fontStyle = FontStyle.Italic),
                        color = PRISMTheme.colors.textSecondary
                    )
                }
            }
