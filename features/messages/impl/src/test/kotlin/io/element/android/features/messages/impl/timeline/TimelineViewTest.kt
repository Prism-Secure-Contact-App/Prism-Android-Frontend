...
import io.prism.android.features.messages.impl.timeline.model.event.aTimelineItemUnknownContent
...
private fun <R : TestRule> AndroidComposeTestRule<R, ComponentActivity>.setTimelineView(
    ...
    onUserDataClick: (PRISMUser) -> Unit = EnsureNeverCalledWithParam(),
