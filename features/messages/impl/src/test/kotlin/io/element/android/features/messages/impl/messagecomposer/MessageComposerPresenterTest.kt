...
import io.prism.android.features.messages.impl.MessagesNavigator
import io.prism.android.features.messages.impl.attachments.Attachment
import io.prism.android.features.messages.impl.draft.ComposerDraftService
import io.prism.android.features.messages.impl.draft.FakeComposerDraftService
import io.prism.android.features.messages.impl.messagecomposer.suggestions.SuggestionsProcessor
import io.prism.android.features.messages.impl.timeline.TimelineController
...
import io.prism.android.features.messages.impl.utils.TextPillificationHelper
...
import io.prism.android.libraries.prism.test.ANOTHER_MESSAGE
import io.prism.android.libraries.prism.test.AN_EVENT_ID
import io.prism.android.libraries.prism.test.A_CAPTION
import io.prism.android.libraries.prism.test.A_MESSAGE
import io.prism.android.libraries.prism.test.A_REPLY
import io.prism.android.libraries.prism.test.A_ROOM_ID
import io.prism.android.libraries.prism.test.A_TRANSACTION_ID
...
import io.prism.android.libraries.prism.test.media.FakeMediaUploadHandler
import io.prism.android.libraries.prism.test.permalink.FakePermalinkBuilder
...
import io.prism.android.tests.testutils.waitForPredicate
        ...
        val presenter = createPresenter(
            permalinkBuilder = FakePermalinkBuilder(
                permalinkForUserLambda = {
                    Result.success("https://prism.to/#/${A_USER_ID_2.value}")
                }
            )
        )
        presenter.test {
            ...
            assertThat(initialState.textEditorState.messageHtml())
                .isEqualTo("Hey <a href='https://prism.to/#/${A_USER_ID_2.value}'>${A_USER_ID_2.value}</a>")
        }
    }
