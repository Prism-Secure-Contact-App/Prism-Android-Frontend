...
import io.prism.android.features.messages.impl.timeline.model.event.isEdited
import io.prism.android.features.messages.impl.timeline.model.event.isRedacted
...
fun TimelineEventTimestampView(
    ...
    val tint = if (hasError || hasEncryptionCritical && !isMessageRedacted) PRISMTheme.colors.textCriticalPrimary else PRISMTheme.colors.textSecondary
    Row(
        modifier = Modifier
...
@PreviewsDayNight
@Composable
internal fun TimelineEventTimestampViewPreview(@PreviewParameter(TimelineItemEventForTimestampViewProvider::class) event: TimelineItem.Event) = PRISMPreview {
