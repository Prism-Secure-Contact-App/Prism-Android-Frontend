...
@PreviewsDayNight
@Composable
internal fun TimelineItemReactionsViewPreview() = PRISMPreview {
    ContentToPreview(
...
@PreviewsDayNight
@Composable
internal fun TimelineItemReactionsViewFewPreview() = PRISMPreview {
    ContentToPreview(
...
@PreviewsDayNight
@Composable
internal fun TimelineItemReactionsViewIncomingPreview() = PRISMPreview {
    ContentToPreview(
...
@PreviewsDayNight
@Composable
internal fun TimelineItemReactionsViewOutgoingPreview() = PRISMPreview {
    ContentToPreview(
        reactions = aTimelineItemReactions(count = 18).reactions,
        isOutgoing = true
    )
