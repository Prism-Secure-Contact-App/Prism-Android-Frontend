...
import io.prism.android.features.messages.impl.timeline.groups.canBeDisplayedInBubbleBlock
import io.prism.android.features.messages.impl.timeline.model.AggregatedReaction
import io.prism.android.features.messages.impl.timeline.model.AggregatedReactionSender
...
import io.prism.android.features.messages.impl.timeline.model.TimelineItemReactions
...
class TimelineItemEventFactory(
    ...
    fun update(
        ...
        receivedPRISMTimelineItem: PRISMTimelineItem.Event,
        roomMembers: List<RoomMember>,
    ): TimelineItem.Event {
        return timelineItem.copy(
            readReceiptState = receivedPRISMTimelineItem.computeReadReceiptState(roomMembers)
        )
    }

    private fun PRISMTimelineItem.Event.computeReactionsState(): TimelineItemReactions {
    ...
    private fun PRISMTimelineItem.Event.computeReadReceiptState(
        roomMembers: List<RoomMember>,
    ...
    private fun computeGroupPosition(
        ...
        val prevTimelineItem =
            timelineItems.getOrNull(index - 1) as? PRISMTimelineItem.Event
