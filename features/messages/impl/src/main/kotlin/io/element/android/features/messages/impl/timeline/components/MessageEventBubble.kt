...
import io.prism.android.features.messages.impl.timeline.model.bubble.BubbleStateProvider
import io.prism.android.libraries.core.extensions.to01
...
import io.prism.android.libraries.ui.utils.graphics.drawInLayer
...
object MessageEventBubbleDefaults {
    ...
    fun backgroundBubbleColor(isMine: Boolean): Color {
        return if (isMine) {
            PRISMTheme.colors.messageFromMeBackground
        } else {
            PRISMTheme.colors.messageFromOtherBackground
        }
    }
...
@PreviewsDayNight
@Composable
internal fun MessageEventBubblePreview(@PreviewParameter(BubbleStateProvider::class) state: BubbleState) = PRISMPreview {
