...
package io.prism.android.features.messages.impl.report
...
@PreviewsDayNight
@Composable
internal fun ReportMessageViewPreview(@PreviewParameter(ReportMessageStateProvider::class) state: ReportMessageState) = PRISMPreview {
    ReportMessageView(
        onBackClick = {},
        state = state,
    )
