...
private fun PinnedMessagesBannerRow(
    ...
    val borderColor = PRISMTheme.colors.pinnedMessageBannerBorder
    Row(
        modifier = modifier
            .background(color = PRISMTheme.colors.bgCanvasDefault)
            .fillMaxWidth()
                ...
                modifier = Modifier
                    ...
                    .background(
                        color = if (index == activeIndex) {
                            ...
                            PRISMTheme.colors.pinnedMessageBannerIndicator
                        } else {
                            Color.Transparent
                        }
                    ),
    ...
    Column(modifier = modifier) {
        AnimatedVisibility(totalCount > 1) {
            Text(
                ...
                color = PRISMTheme.colors.textActionAccent,
                maxLines = 1,
...
@PreviewsDayNight
@Composable
internal fun PinnedMessagesBannerViewPreview(@PreviewParameter(PinnedMessagesBannerStateProvider::class) state: PinnedMessagesBannerState) = PRISMPreview {
