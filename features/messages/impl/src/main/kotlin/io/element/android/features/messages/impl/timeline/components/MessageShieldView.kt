...
internal fun MessageShieldData.toIconColor(): Color {
    return when (isCritical) {
        true -> PRISMTheme.colors.iconCriticalPrimary
        false -> PRISMTheme.colors.iconSecondary
    }
}
...
private fun MessageShieldData.toTextColor(): Color {
    return when (isCritical) {
        true -> PRISMTheme.colors.textCriticalPrimary
        false -> PRISMTheme.colors.textSecondary
    }
}
