...
package io.prism.android.features.messages.impl.timeline.components.customreaction.picker
...
@PreviewsDayNight
@Composable
internal fun EmojiPickerPreview(@PreviewParameter(EmojiPickerStateProvider::class) state: EmojiPickerState) = PRISMPreview {
    EmojiPicker(
        onSelectEmoji = {},
        state = state,
