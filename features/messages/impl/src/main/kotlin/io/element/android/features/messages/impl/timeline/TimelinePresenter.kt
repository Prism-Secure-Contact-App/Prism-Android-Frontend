...
import io.prism.android.features.messages.impl.crypto.sendfailure.resolve.ResolveVerifiedUserSendFailureEvent
...
import io.prism.android.services.analytics.api.AnalyticsLongRunningTransaction.DisplayFirstTimelineItems
    ...
    override fun present(): TimelineState {
        ...
        LaunchedEffect(Unit) {
            ...
            combine(timelineController.timelineItems(), room.membersStateFlow) { items, membersState ->
                ...
                .onEach(redactedVoiceMessageManager::onEachPRISMTimelineItem)
