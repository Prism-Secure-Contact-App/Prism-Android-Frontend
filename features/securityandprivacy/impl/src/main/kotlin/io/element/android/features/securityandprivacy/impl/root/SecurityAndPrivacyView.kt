...
import io.prism.android.libraries.designsystem.text.stringWithLink
...
private fun RoomAddressSection(
    ...
    SecurityAndPrivacySection(
        ...
        ListItem(
            ...
            colors = ListItemDefaults.colors(trailingIconColor = PRISMTheme.colors.iconAccentPrimary),
        )
