...
import io.prism.android.features.announcement.impl.R
...
/**
 * Ref: https://www.figma.com/design/kcnHxunG1LDWXsJhaNuiHz/ER-145--Spaces-on-PRISM-X?node-id=4593-40181
 */
@Composable
...
private fun SpaceAnnouncementContent(
    ...
    Column(
        ...
        InfoListOrganism(
            ...
            iconTint = PRISMTheme.colors.iconSecondary,
            iconSize = 24.dp
        )
        Text(
            modifier = Modifier
...
@PreviewsDayNight
@Composable
internal fun SpaceAnnouncementViewPreview(@PreviewParameter(SpaceAnnouncementStateProvider::class) state: SpaceAnnouncementState) = PRISMPreview {
