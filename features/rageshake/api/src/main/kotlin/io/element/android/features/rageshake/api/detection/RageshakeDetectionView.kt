...
import io.prism.android.features.rageshake.api.screenshot.screenshot
import io.prism.android.libraries.androidutils.hardware.vibrate
...
@PreviewsDayNight
@Composable
internal fun RageshakeDialogContentPreview() = PRISMPreview {
    RageshakeDialogContent()
}
