...
import io.prism.android.features.rageshake.impl.R
...
import io.prism.android.libraries.designsystem.components.preferences.PreferenceRow
...
@Composable
internal fun BugReportViewDayPreview(@PreviewParameter(BugReportStateProvider::class) state: BugReportState) = PRISMPreview {
    BugReportView(
        state = state,
        onSuccess = {},
        onBackClick = {},
...
@Composable
internal fun BugReportViewNightPreview(@PreviewParameter(BugReportStateProvider::class) state: BugReportState) = PRISMPreview {
    BugReportView(
        state = state,
        onSuccess = {},
        onBackClick = {},
