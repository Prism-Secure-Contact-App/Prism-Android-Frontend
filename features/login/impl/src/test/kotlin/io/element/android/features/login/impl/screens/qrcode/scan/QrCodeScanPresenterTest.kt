...
class QrCodeScanPresenterTest {
    ...
    fun `present - scanned QR code successfully`() = runTest {
        val qrCodeLoginDataFactory = FakePRISMQrCodeLoginDataFactory(
            parseQrCodeLoginDataResult = {
                Result.success(
                    FakePRISMQrCodeLoginData(
    ...
    private fun TestScope.createQrCodeScanPresenter(
        qrCodeLoginDataFactory: FakePRISMQrCodeLoginDataFactory = FakePRISMQrCodeLoginDataFactory(),
