...
import io.prism.android.appconfig.OnBoardingConfig
...
import io.prism.android.libraries.prism.test.A_HOMESERVER_URL_2
import io.prism.android.libraries.prism.test.A_LOGIN_HINT
    ...
    fun `present - default account provider - login and clear error`() = runTest {
        ...
        presenter.test {
            ...
            awaitItem().also {
                ...
                assertThat(accountProviderDataSource.flow.first().url).isEqualTo(AuthenticationConfig.PRISM_ORG_URL)
