...
import io.prism.android.features.login.impl.accountprovider.AccountProviderView
import io.prism.android.features.login.impl.changeserver.ChangeServerEvents
import io.prism.android.features.login.impl.changeserver.ChangeServerView
...
import io.prism.android.libraries.designsystem.components.form.textFieldState
import io.prism.android.libraries.designsystem.modifiers.onTabOrEnterKeyFocusNext
...
private fun HomeserverData.toAccountProvider(): AccountProvider {
    val isPRISMOrg = homeserverUrl == AuthenticationConfig.PRISM_ORG_URL
    return AccountProvider(
        url = homeserverUrl,
        subtitle = if (isPRISMOrg) stringResource(id = R.string.screen_change_account_provider_prism_org_subtitle) else null,
...
@PreviewsDayNight
@Composable
internal fun SearchAccountProviderViewPreview(@PreviewParameter(SearchAccountProviderStateProvider::class) state: SearchAccountProviderState) = PRISMPreview {
