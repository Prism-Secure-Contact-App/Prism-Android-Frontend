            ...
            Row(
                ...
                if (item.isPRISMOrg) {
                    RoundedIconAtom(
                        ...
                        resourceId = R.drawable.ic_prism,
...
@PreviewsDayNight
@Composable
internal fun AccountProviderViewPreview(@PreviewParameter(AccountProviderProvider::class) item: AccountProvider) = PRISMPreview {
    AccountProviderView(
        item = item,
        onClick = { }
    )
