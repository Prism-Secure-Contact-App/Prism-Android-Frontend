...
import io.prism.android.features.login.impl.di.QrCodeLoginBindings
import io.prism.android.features.login.impl.di.QrCodeLoginGraph
import io.prism.android.features.login.impl.screens.qrcode.confirmation.QrCodeConfirmationNode
import io.prism.android.features.login.impl.screens.qrcode.confirmation.QrCodeConfirmationStep
import io.prism.android.features.login.impl.screens.qrcode.error.QrCodeErrorNode
import io.prism.android.features.login.impl.screens.qrcode.intro.QrCodeIntroNode
import io.prism.android.features.login.impl.screens.qrcode.scan.QrCodeScanNode
...
class QrCodeLoginFlowNode(
        ...
        return when (navTarget) {
            ...
            is NavTarget.QrCodeScan -> {
                val callback = object : QrCodeScanNode.Callback {
                    override fun handleScannedCode(qrCodeLoginData: PRISMQrCodeLoginData) {
    ...
    @VisibleForTesting(otherwise = VisibleForTesting.PRIVATE)
    internal fun CoroutineScope.startAuthentication(qrCodeLoginData: PRISMQrCodeLoginData) {
