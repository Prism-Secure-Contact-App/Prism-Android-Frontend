...
import io.prism.android.features.login.impl.screens.onboarding.classic.ConfirmingLoginWithPRISMClassic
import io.prism.android.features.login.impl.screens.onboarding.classic.LoginWithClassicEvent
import io.prism.android.features.login.impl.screens.onboarding.classic.LoginWithClassicState
import io.prism.android.libraries.architecture.AsyncData
import io.prism.android.libraries.designsystem.atomic.atoms.PRISMLogoAtom
import io.prism.android.libraries.designsystem.atomic.atoms.PRISMLogoAtomSize
...
import io.prism.android.libraries.designsystem.atomic.pages.OnBoardingPage
...
// PRISMX:
// - https://www.figma.com/file/0MMNu7cTOzLOlWb7ctTkv3/PRISM-X?type=design&node-id=1816-97419
@Composable
fun OnBoardingView(
    ...
    LoginWithPRISMClassicView(
        state = state.loginWithClassicState,
    )
}

@Composable
private fun LoginWithPRISMClassicView(
...
private fun OnBoardingContent(state: OnBoardingState) {
    Box(
        ...
        Box(
            ...
            PRISMLogoAtom(
                size = PRISMLogoAtomSize.Large,
                modifier = Modifier.padding(top = PRISMLogoAtomSize.Large.shadowRadius / 2)
            )
        }
        Box(
            modifier = Modifier.fillMaxSize(),
