...
fun QrCodeScanView(
    ...
    onBackClick: () -> Unit,
    onQrCodeDataReady: (PRISMQrCodeLoginData) -> Unit,
            ...
            is AsyncAction.Failure -> {
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = when (error) {
                                is AccountProviderAccessException.NeedPRISMProException -> {
                                    stringResource(R.string.screen_change_server_error_prism_pro_required_title)
                                }
...
@PreviewsDayNight
@Composable
internal fun QrCodeScanViewPreview(@PreviewParameter(QrCodeScanStateProvider::class) state: QrCodeScanState) = PRISMPreview {
    QrCodeScanView(
        state = state,
        onQrCodeDataReady = {},
        onBackClick = {},
