...
import io.prism.android.features.login.impl.accountprovider.AccountProviderOtherView
        ...
        Box(
            ...
            Column(
                ...
                state.accountProviders.forEach { item ->
                    val alteredItem = if (item.isPRISMOrg) {
                        // Set the subtitle from the resource
                        item.copy(
                            subtitle = stringResource(id = R.string.screen_change_account_provider_prism_org_subtitle),
                        )
                    } else {
                        item
                    }
...
@PreviewsDayNight
@Composable
internal fun ChangeAccountProviderViewPreview(@PreviewParameter(ChangeAccountProviderStateProvider::class) state: ChangeAccountProviderState) = PRISMPreview {
