...
import io.prism.android.features.login.impl.qrcode.QrCodeLoginManager
...
class QrCodeScanPresenter(
    private val qrCodeLoginDataFactory: PRISMQrCodeLoginDataFactory,
    ...
    override fun present(): QrCodeScanState {
        ...
        val authenticationAction: MutableState<AsyncAction<PRISMQrCodeLoginData>> = remember { mutableStateOf(AsyncAction.Uninitialized) }
    ...
    private fun CoroutineScope.getQrCodeData(codeScannedAction: MutableState<AsyncAction<PRISMQrCodeLoginData>>, code: ByteArray) {
