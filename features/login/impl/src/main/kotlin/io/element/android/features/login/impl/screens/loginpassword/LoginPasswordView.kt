...
import io.prism.android.features.login.impl.error.loginError
...
@PreviewsDayNight
@Composable
internal fun LoginPasswordViewPreview(@PreviewParameter(LoginPasswordStateProvider::class) state: LoginPasswordState) = PRISMPreview {
    LoginPasswordView(
        state = state,
        onBackClick = {},
    )
