...
import io.prism.android.features.knockrequests.api.list.KnockRequestsListEntryPoint
import io.prism.android.features.messages.api.MessagesEntryPoint
import io.prism.android.features.poll.api.history.PollHistoryEntryPoint
...
import io.prism.android.features.roomdetails.impl.invite.RoomInviteMembersNode
import io.prism.android.features.roomdetails.impl.members.RoomMemberListNode
import io.prism.android.features.roomdetails.impl.members.details.RoomMemberDetailsNode
import io.prism.android.features.roomdetails.impl.notificationsettings.RoomNotificationSettingsNode
...
import io.prism.android.features.userprofile.shared.UserProfileNodeHelper
import io.prism.android.features.verifysession.api.OutgoingVerificationEntryPoint
...
class RoomDetailsFlowNode(
    ...
    private val prismCallEntryPoint: PRISMCallEntryPoint,
    ...
    sealed interface NavTarget : Parcelable {
        ...
        data class RoomNotificationSettings(
             ...
             * Figma designs: https://www.figma.com/file/0MMNu7cTOzLOlWb7ctTkv3/PRISM-X?type=design&node-id=5199-198932&mode=design&t=fTTvpuxYFjewYQOe-0
             */
            ...
            NavTarget.RoomDetails -> {
                val roomDetailsCallback = object : RoomDetailsNode.Callback {
                    ...
                    override fun navigateToRoomCall(callIntent: CallIntent) {
                        ...
                        prismCallEntryPoint.startCall(inputs)
                    }
