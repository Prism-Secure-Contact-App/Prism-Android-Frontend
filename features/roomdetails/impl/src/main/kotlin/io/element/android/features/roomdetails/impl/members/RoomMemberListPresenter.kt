...
import io.prism.android.features.roommembermoderation.api.RoomMemberModerationEvents.ShowActionsForUser
        ...
        fun handleEvent(event: RoomMemberListEvent) {
            when (event) {
                is RoomMemberListEvent.RoomMemberSelected ->
                    roomModerationState.eventSink(ShowActionsForUser(event.roomMember.toPRISMUser()))
