...
import io.prism.android.features.home.impl.components.RoomSummaryRow
...
@PreviewsDayNight
@Composable
internal fun RoomListSearchContentPreview(@PreviewParameter(RoomListSearchStateProvider::class) state: RoomListSearchState) = PRISMPreview {
    RoomListSearchContent(
        state = state,
