...
import io.prism.android.features.home.impl.model.RoomListRoomSummaryProvider
...
import io.prism.android.libraries.designsystem.theme.roomListRoomMessage
    ...
    Row(
        ...
        Row(
            ...
            Text(
                ...
                color = PRISMTheme.colors.roomListRoomName,
                maxLines = 1,
                overflow = TextOverflow.Ellipsis
            )
        }
        ...
        Text(
            ...
            color = if (isHighlighted) {
                PRISMTheme.colors.unreadIndicator
            } else {
                PRISMTheme.colors.roomListRoomMessageDate
            },
        )
    }
}
...
private fun InviteSubtitle(
    ...
    if (subtitle != null) {
        Text(
            ...
            overflow = TextOverflow.Ellipsis,
            style = PRISMTheme.typography.fontBodyMdRegular,
            color = PRISMTheme.colors.roomListRoomMessage,
            modifier = modifier,
        )
    }
}
...
private fun MessagePreviewAndIndicatorRow(
    ...
    Row(
        ...
        Row(
            ...
            val tint = if (room.isHighlighted) PRISMTheme.colors.unreadIndicator else PRISMTheme.colors.iconQuaternary
            if (room.hasRoomCall) {
                OnGoingCallIcon(
                    color = tint,
                )
...
private fun NotificationOffIndicatorAtom() {
    Icon(
        ...
        tint = PRISMTheme.colors.iconQuaternary,
    )
}
...
private fun MentionIndicatorAtom() {
    Icon(
        ...
        tint = PRISMTheme.colors.unreadIndicator,
    )
}

@PreviewsDayNight
@Composable
internal fun RoomSummaryRowPreview(@PreviewParameter(RoomListRoomSummaryProvider::class) data: RoomListRoomSummary) = PRISMPreview {
    RoomSummaryRow(
        room = data,
