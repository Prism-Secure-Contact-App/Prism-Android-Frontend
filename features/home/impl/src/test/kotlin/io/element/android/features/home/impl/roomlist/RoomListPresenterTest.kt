...
import io.prism.android.features.home.impl.model.createRoomListRoomSummary
import io.prism.android.features.home.impl.search.RoomListSearchEvent
import io.prism.android.features.home.impl.search.RoomListSearchState
import io.prism.android.features.home.impl.search.aRoomListSearchState
import io.prism.android.features.home.impl.spacefilters.SpaceFiltersState
import io.prism.android.features.home.impl.spacefilters.aDisabledSpaceFiltersState
...
import io.prism.android.features.rageshake.test.logs.FakeAnnouncementService
...
import io.prism.android.services.analytics.test.watchers.FakeAnalyticsColdStartWatcher
...
class RoomListPresenterTest {
    ...
    fun `present - handle DismissRequestVerificationPrompt`() = runTest {
        ...
        val presenter = createRoomListPresenter(
            client = FakePRISMClient(roomListService = roomListService, encryptionService = encryptionService, syncService = syncService),
        )
        presenter.test {
