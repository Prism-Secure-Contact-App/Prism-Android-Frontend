...
package io.prism.android.features.linknewdevice.impl.screens.number.component
...
import io.prism.android.features.linknewdevice.impl.screens.number.model.Number
...
private fun DigitView(
    ...
    val appearanceModifier = when (digit) {
        ...
        is Digit.Filled -> {
            Modifier.background(PRISMTheme.colors.bgActionSecondaryPressed, shape)
        }
    }
    Box(
        modifier = Modifier
    ...
    if (isCursorVisible) {
        Spacer(
            modifier = Modifier
                .size(2.dp, 24.dp)
                .offset(x = (-5).dp)
                .background(PRISMTheme.colors.textPrimary, RoundedCornerShape(1.dp))
        )
    }
}
