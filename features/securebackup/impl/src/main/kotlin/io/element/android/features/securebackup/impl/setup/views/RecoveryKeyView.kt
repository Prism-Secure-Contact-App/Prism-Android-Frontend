...
package io.prism.android.features.securebackup.impl.setup.views
...
import io.prism.android.features.securebackup.impl.tools.RecoveryKeyVisualTransformation
import io.prism.android.libraries.designsystem.modifiers.clickableIfNotNull
...
private fun RecoveryKeyWithCopy(
    ...
    Row(
        ...
        Text(
            ...
            style = PRISMTheme.typography.fontBodyLgRegular.copy(fontFamily = FontFamily.Monospace),
