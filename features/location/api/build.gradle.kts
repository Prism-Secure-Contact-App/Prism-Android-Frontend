...
android {
    namespace = "io.prism.android.features.location.api"
    ...
    defaultConfig {
        ...
        buildConfigFieldStr(
            ...
            value = if (isEnterpriseBuild) {
                ...
                System.getenv("PRISM_ANDROID_MAPTILER_API_KEY")
        ...
        buildConfigFieldStr(
            ...
            value = if (isEnterpriseBuild) {
                ...
                System.getenv("PRISM_ANDROID_MAPTILER_LIGHT_MAP_ID")
        ...
        buildConfigFieldStr(
            ...
            value = if (isEnterpriseBuild) {
                ...
                System.getenv("PRISM_ANDROID_MAPTILER_DARK_MAP_ID")
