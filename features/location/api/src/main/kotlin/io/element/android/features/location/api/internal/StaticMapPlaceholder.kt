...
package io.prism.android.features.location.api.internal
...
import io.prism.android.features.location.api.R
...
@PreviewsDayNight
@Composable
internal fun StaticMapPlaceholderPreview() = PRISMPreview {
    Column(
