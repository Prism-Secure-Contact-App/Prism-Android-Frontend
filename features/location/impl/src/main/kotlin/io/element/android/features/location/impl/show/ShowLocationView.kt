...
import io.prism.android.features.location.impl.common.ui.LocationPinMarkers
import io.prism.android.features.location.impl.common.ui.LocationShareRow
...
@PreviewsDayNight
@Composable
internal fun ShowLocationViewPreview(@PreviewParameter(ShowLocationStateProvider::class) state: ShowLocationState) = PRISMPreview {
    ShowLocationView(
        state = state,
        onBackClick = {},
    )
