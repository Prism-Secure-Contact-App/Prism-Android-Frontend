    ...
    if (location != null) {
        LocationPuck(
            ...
            colors = LocationPuckColors(
                dotFillColorCurrentLocation = PRISMTheme.colors.iconAccentPrimary,
                dotFillColorOldLocation = PRISMTheme.colors.iconAccentTertiary,
                dotStrokeColor = PRISMTheme.colors.bgCanvasDefault,
            )
        )
    }
}
