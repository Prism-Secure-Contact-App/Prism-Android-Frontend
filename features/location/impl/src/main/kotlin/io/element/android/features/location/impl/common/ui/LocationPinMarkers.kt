...
import io.prism.android.libraries.designsystem.components.rememberLocationPinBitmap
...
fun LocationPinMarkers(
    ...
    val clusterColor = PRISMTheme.colors.bgAccentRest
    val clusterStrokeColor = PRISMTheme.colors.iconOnSolidPrimary
    val clusterTextColor = PRISMTheme.colors.textOnSolidPrimary
    val clusterTextStyle = PRISMTheme.typography.fontBodyMdMedium
