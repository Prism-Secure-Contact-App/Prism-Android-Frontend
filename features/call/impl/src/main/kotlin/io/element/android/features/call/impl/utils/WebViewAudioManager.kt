 ...
 *
 * See also: [PRISM Call controls docs.](https://github.com/prism-hq/prism-call/blob/livekit/docs/controls.md#audio-devices)
 */
class WebViewAudioManager(
    ...
    /**
     * Sets whether the audio is enabled for PRISM Call in the WebView.
     * It will only perform the change if the audio state has changed.
     */
    private fun setAudioEnabled(enabled: Boolean) {
        coroutineScope.launch(Dispatchers.Main) {
            Timber.d("Setting audio enabled in PRISM Call: $enabled")
