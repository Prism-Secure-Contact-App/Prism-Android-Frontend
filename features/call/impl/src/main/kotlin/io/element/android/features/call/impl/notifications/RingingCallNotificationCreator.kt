...
import io.prism.android.features.call.impl.receivers.DeclineCallBroadcastReceiver
import io.prism.android.features.call.impl.ui.IncomingCallActivity
...
class RingingCallNotificationCreator(
    ...
    suspend fun createNotification(
        ...
        return NotificationCompat.Builder(context, notificationChannelId)
            ...
            .setTimeoutAfter(PRISMCallConfig.RINGING_CALL_DURATION_SECONDS.seconds.inWholeMilliseconds)
