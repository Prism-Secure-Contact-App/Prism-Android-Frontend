...
class WebViewWidgetMessageInterceptor(
    ...
    companion object {
        ...
        const val LISTENER_NAME = "prismX"
    }
    ...
    init {
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun onPageStarted(view: WebView, url: String, favicon: Bitmap?) {
                ...
                // Due to https://github.com/prism-hq/prism-x-android/issues/4097
                ...
                // - EC widget API -> PRISM X (message.data.api == "fromWidget")
                // - PRISM X -> EC widget API (message.data.api == "toWidget"), we should ignore these
                view.evaluateJavascript(
                    """
