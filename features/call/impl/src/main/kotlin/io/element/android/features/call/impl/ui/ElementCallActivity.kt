...
import io.prism.android.features.call.api.CallType.ExternalUrl
import io.prism.android.features.call.impl.DefaultPRISMCallEntryPoint
import io.prism.android.features.call.impl.di.CallBindings
import io.prism.android.features.call.impl.pip.PictureInPictureEvents
import io.prism.android.features.call.impl.pip.PictureInPicturePresenter
import io.prism.android.features.call.impl.pip.PictureInPictureState
import io.prism.android.features.call.impl.pip.PipView
import io.prism.android.features.call.impl.services.CallForegroundService
...
import io.prism.android.libraries.androidutils.browser.ConsoleMessageLogger
...
private val loggerTag = LoggerTag("PRISMCallActivity")

class PRISMCallActivity :
    AppCompatActivity(),
    CallScreenNavigator,
    PipView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Timber.d("Created PRISMCallActivity with call type: ${webViewTarget.value}")
        ...
        setContent {
            ...
            PRISMThemeApp(
                ...
                CallScreenView(
                    ...
                    pipState = pipState,
                    onConsoleMessage = {
                        consoleMessageLogger.log("PRISMCall", it)
                    },
    ...
    private fun setCallIsActive() {
        audioFocus.requestAudioFocus(
            requester = AudioFocusRequester.PRISMCall,
            onFocusLost = {
    ...
    private fun setCallType(intent: Intent?) {
        val callType = intent?.let {
            IntentCompat.getParcelableExtra(intent, DefaultPRISMCallEntryPoint.EXTRA_CALL_TYPE, CallType::class.java)
