...
@PreviewsDayNight
@Composable
internal fun PollContentViewUndisclosedPreview() = PRISMPreview {
    PollContentView(
...
@PreviewsDayNight
@Composable
internal fun PollContentViewDisclosedPreview() = PRISMPreview {
    PollContentView(
        eventId = EventId("\$anEventId"),
        question = "What type of food should we have at the party?",
...
@PreviewsDayNight
@Composable
internal fun PollContentViewEndedPreview() = PRISMPreview {
    PollContentView(
        eventId = EventId("\$anEventId"),
        question = "What type of food should we have at the party?",
...
@PreviewsDayNight
@Composable
internal fun PollContentViewCreatorEditablePreview() = PRISMPreview {
    PollContentView(
        eventId = EventId("\$anEventId"),
        question = "What type of food should we have at the party?",
...
@PreviewsDayNight
@Composable
internal fun PollContentViewCreatorPreview() = PRISMPreview {
    PollContentView(
        eventId = EventId("\$anEventId"),
        question = "What type of food should we have at the party?",
...
@PreviewsDayNight
@Composable
internal fun PollContentViewCreatorEndedPreview() = PRISMPreview {
    PollContentView(
        eventId = EventId("\$anEventId"),
        question = "What type of food should we have at the party?",
        answerItems = aPollAnswerItemList(isEnded = true),
