...
package io.prism.android.features.poll.impl.pollcontent
...
import io.prism.android.libraries.matrix.test.A_USER_ID_10
...
import io.prism.android.libraries.matrix.test.A_USER_ID_8
import io.prism.android.libraries.matrix.test.A_USER_ID_9
...
class PollContentStateFactoryTest {
    private val factory = DefaultPollContentStateFactory(FakePRISMClient())
