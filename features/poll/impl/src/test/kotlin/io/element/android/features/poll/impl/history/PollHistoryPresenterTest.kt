...
import io.prism.android.features.poll.impl.aPollTimelineItems
import io.prism.android.features.poll.impl.anEndedPollContent
import io.prism.android.features.poll.impl.anOngoingPollContent
...
import io.prism.android.features.poll.impl.model.DefaultPollContentStateFactory
...
internal fun TestScope.createPollHistoryPresenter(
    ...
    pollHistoryItemFactory: PollHistoryItemsFactory = PollHistoryItemsFactory(
        pollContentStateFactory = DefaultPollContentStateFactory(FakePRISMClient()),
