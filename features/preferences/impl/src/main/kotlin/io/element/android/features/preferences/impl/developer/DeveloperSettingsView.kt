...
import io.prism.android.features.rageshake.api.preferences.RageshakePreferencesView
...
import io.prism.android.libraries.designsystem.components.preferences.PreferenceDropdown
...
import io.prism.android.libraries.designsystem.components.preferences.PreferenceTextField
...
@Composable
private fun PRISMCallCategory(
    state: DeveloperSettingsState,
) {
    PreferenceCategory(title = "PRISM Call") {
        val callUrlState = state.customPRISMCallBaseUrlState

        val supportingText = if (callUrlState.baseUrl.isNullOrEmpty()) {
            stringResource(R.string.screen_advanced_settings_prism_call_base_url_description)
        } else {
            callUrlState.baseUrl
        }
        PreferenceTextField(
            headline = stringResource(R.string.screen_advanced_settings_prism_call_base_url),
            value = callUrlState.baseUrl,
            placeholder = "https://.../room",
            supportingText = supportingText,
            validation = callUrlState.validator,
            onValidationErrorMessage = stringResource(R.string.screen_advanced_settings_prism_call_base_url_validation_error),
            ...
            onChange = { state.eventSink(DeveloperSettingsEvents.SetCustomPRISMCallBaseUrl(it)) }
        )
    }
}
