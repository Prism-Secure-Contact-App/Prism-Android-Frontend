...
import io.prism.android.features.analytics.api.preferences.AnalyticsPreferencesView
...
@PreviewsDayNight
@Composable
internal fun AnalyticsSettingsViewPreview(@PreviewParameter(AnalyticsSettingsStateProvider::class) state: AnalyticsSettingsState) = PRISMPreview {
