...
import io.prism.android.libraries.designsystem.components.dialogs.ListOption
import io.prism.android.libraries.designsystem.components.dialogs.SingleSelectionDialog
...
fun NotificationSettingsView(
    ...
    PreferencePage(
        ...
        when (state.prismSettings) {
            is NotificationSettingsState.PRISMSettings.Invalid -> InvalidNotificationSettingsView(
                showError = state.prismSettings.fixFailed,
            ...
            NotificationSettingsState.PRISMSettings.Uninitialized -> return@PreferencePage
            is NotificationSettingsState.PRISMSettings.Valid -> NotificationSettingsContentView(
                prismSettings = state.prismSettings,
                state = state,
...
private fun NotificationSettingsContentView(
    prismSettings: NotificationSettingsState.PRISMSettings.Valid,
    state: NotificationSettingsState,
    ...
    if (systemSettings.appNotificationsEnabled) {
        ...
        PreferenceCategory(title = stringResource(id = R.string.screen_notification_settings_notification_section_title)) {
            ListItem(
                ...
                supportingContent = {
                    Text(getTitleForRoomNotificationMode(mode = prismSettings.defaultGroupNotificationMode))
                },
            ...
            ListItem(
                ...
                supportingContent = {
                    Text(getTitleForRoomNotificationMode(mode = prismSettings.defaultOneToOneNotificationMode))
                },
        ...
        PreferenceCategory(title = stringResource(id = R.string.screen_notification_settings_mode_mentions)) {
            PreferenceSwitch(
                ...
                isChecked = prismSettings.atRoomNotificationsEnabled,
...
//                    isChecked = prismSettings.callNotificationsEnabled,
...
//                )
            PreferenceSwitch(
                ...
                isChecked = prismSettings.inviteForMeNotificationsEnabled,
...
@PreviewsDayNight
@Composable
internal fun NotificationSettingsViewPreview(@PreviewParameter(NotificationSettingsStateProvider::class) state: NotificationSettingsState) = PRISMPreview {
