...
fun aLoadedContentState(
    ...
    name: String? = "PRISM X android",
    alias: RoomAlias? = RoomAlias("#exa:prism.org"),
    topic: String? = "PRISM X is a secure, private and decentralized messenger.",
...
private val A_ROOM_ID = RoomId("!exa:prism.org")
